...
const fontPath = 'https://raw.githubusercontent.com/Simbs38/Vazo/master/src/fonts/Bebas%20Neue_Regular.json'
...
export function startHeader ():void {
    ...
    promiss.then(args => {
        ...
        const outlinePass = new OutlinePass(new THREE.Vector2(1024, 1024), head.scene, camera, outlineObjects)
